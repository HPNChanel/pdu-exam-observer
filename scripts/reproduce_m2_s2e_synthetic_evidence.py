"""Offline strict same-revision reproduction for one M2-S2D bundle."""
...
from pdu_exam_observer.m2_synthetic_reproduction import (  # noqa: E402
...
def main(arguments: list[str] | None = None) -> int:
    try:
        ...
        receipt = reproduce_synthetic_evidence_bytes(b"")
